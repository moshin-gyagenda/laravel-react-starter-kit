                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem asChild>
                                  <a href={`/purchase-orders/${order.id}`} className="flex items-center cursor-pointer">
              ...
              <div className="flex gap-2 self-end sm:self-auto">
                {purchaseOrders.meta && purchaseOrders.meta.current_page > 1 && (
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      purchaseOrders.meta && router.get(`/purchase-orders?page=${purchaseOrders.meta.current_page - 1}`)
                    }
                  >
                    Previous
                  </Button>
